...
export default function Footer() {
  ...
  return (
    <footer className="mt-20 mx-auto bg-background">
      <div className="mx-auto w-full max-w-screen-xl">
        <div className="mx-auto grid  w-full grid-cols-2 gap-8 px-4 py-6 md:grid-cols-5 lg:py-8">
          <div>
          ...
          <div className="mt-20 space-y-5">
            <GooglePlayButton url={APKUrl} theme={"dark"} className={""} />
            <AppStoreButton url={APKUrl} theme={"dark"} className={""} />
          </div>
        </div>
        <div className="px-4 py-6 md:flex md:items-center md:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-300">
            © 2023 <a href="https://learnpro.com/">Learn-Pro™</a>. All Rights
            Reserved.
          </span>
